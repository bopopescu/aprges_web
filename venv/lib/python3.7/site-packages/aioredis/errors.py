...
class ReadOnlyError(RedisError):
    """Raised from subordinate when read-only mode is enabled"""


class MainNotFoundError(RedisError):
    """Raised for sentinel main not found error."""


class SubordinateNotFoundError(RedisError):
    """Raised for sentinel subordinate not found error."""


class MainReplyError(RedisError):
    """Raised by sentinel client for main error replies."""


class SubordinateReplyError(RedisError):
    """Raised by sentinel client for subordinate error replies."""
